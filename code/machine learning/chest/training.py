...
# Define data transformations for chest X-rays
...
# Training function
def train_model(model, dataloaders, criterion, optimizer, scheduler, num_epochs=20, model_type="chest", checkpoints_dir='checkpoints'):
